...
def _gold_record(
    ...
    *,
    ...
    return {
        ...
        "static_label_defect_reasons": label["static_label_defect_reasons"],
        "label_issue_codes": label["label_issue_codes"],
        "evidence_mapping_failure": label["evidence_mapping_failure"],
        "evidence_issue_codes": label["evidence_issue_codes"],
